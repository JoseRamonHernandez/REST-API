...
router.post('/insertDocument/:id', insertDocument)
...
router.get('/getOperation/:id', getOperation)
...
//RUTAS PARA APLICATOR

router.get('/getAplicators', getAplicators)

router.post('/createAplicator', createAplicator)

router.post('/updateAplicator/:id', updateAplicator)

router.get('/deleteAplicator/:id', deleteAplicator)

router.get('/findAplicatorID/:id', findAplicatorID)
